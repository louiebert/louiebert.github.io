  ...
  return (
    <li className="card-li">
      <div className="card transition">
        ...
        <p className="short transition">
          {shortDescription}
        </p>
        <p className={`long transition ${className}`}>
          {longDescription}
        </p>
        {ctaText && ctaUrl && (
          <div className={`cta-container transition ${className}`}>
            <a href={ctaUrl} target="_blank" rel="noopener noreferrer" className="cta">
              {ctaText}
            </a>
          </div>
        )}
...
const Experience: React.FC = () => {
  return (
    <>
      ...
      <section className="section_title experience">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex flex-wrap">
            <div className="sm:w-8/12 sm:mx-auto mx-4">
              <p>
                My experience in the field of Computer Science consists of about five years of mostly independent research. Until I arrived
                at Missouri S&T, I found it difficult to acquire a formal education in this incredible field, so
                I have spent a great deal of time teaching myself the ins and outs of programming. Some of the products
                this education has enabled me to do include:
              </p>
            </div>
          </div>
          <div className="flex flex-wrap">
